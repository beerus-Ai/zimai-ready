...
export const DOMAINS: Domain[] = [
  { id: 'finance', name: 'Finance & Accounting', shortName: 'Finance', professional: 'Finance Professionals', competency: 'AI-Augmented Financial Operations', icon: 'Calculator', color: '#0a8a5f', description: 'AI for analysis, reporting, reconciliation and financial risk.', domainSkillId: 'domain-finance', moduleIds: ['fin-analysis', 'fin-automation', 'fin-risk', 'fin-challenge'] },
  { id: 'hr', name: 'Human Resources', shortName: 'HR', professional: 'HR Professionals', competency: 'AI-Enabled People Management', icon: 'Users', color: '#7c3aed', description: 'AI for recruitment, people analytics and employee experience.', domainSkillId: 'domain-hr', moduleIds: ['hr-recruitment', 'hr-analytics', 'hr-experience', 'hr-challenge'] },
  { id: 'marketing', name: 'Marketing & Sales', shortName: 'Marketing', professional: 'Marketing & Sales Professionals', competency: 'AI-Powered Marketing & Customer Growth', icon: 'Megaphone', color: '#db2777', description: 'AI for campaigns, content, insights and sales.', domainSkillId: 'domain-marketing', moduleIds: ['mkt-content', 'mkt-insights', 'mkt-sales', 'mkt-challenge'] },
  { id: 'software', name: 'Software & IT', shortName: 'Software/IT', professional: 'Software & IT Professionals', competency: 'AI-Assisted Software Engineering', icon: 'Code2', color: '#2563eb', description: 'AI pair programming, secure code review and IT automation.', domainSkillId: 'domain-software', moduleIds: ['sw-coding', 'sw-security', 'sw-automation', 'sw-challenge'] },
  { id: 'customer-service', name: 'Customer Service', shortName: 'Customer Service', professional: 'Customer Service Professionals', competency: 'AI-Enhanced Customer Experience', icon: 'Headset', color: '#0891b2', description: 'AI-assisted responses, chatbots and service analytics.', domainSkillId: 'domain-customer-service', moduleIds: ['cs-assist', 'cs-chatbots', 'cs-insights', 'cs-challenge'] },
  { id: 'operations', name: 'Operations', shortName: 'Operations', professional: 'Operations Professionals', competency: 'AI-Optimised Operations', icon: 'Settings2', color: '#ea580c', description: 'AI for processes, maintenance, supply chains and safety.', domainSkillId: 'domain-operations', moduleIds: ['ops-process', 'ops-maintenance', 'ops-safety', 'ops-challenge'] },
  { id: 'management', name: 'Management & Leadership', shortName: 'Management', professional: 'Managers & Leaders', competency: 'AI-Informed Leadership & Decision-Making', icon: 'Crown', color: '#b45309', description: 'AI for decisions, strategy, change and governance.', domainSkillId: 'domain-management', moduleIds: ['mgmt-decisions', 'mgmt-strategy', 'mgmt-governance', 'mgmt-challenge'] },
  { id: 'agriculture', name: 'Agriculture', shortName: 'Agriculture', professional: 'Agriculture Professionals', competency: 'AI-Driven Agricultural Productivity', icon: 'Sprout', color: '#65a30d', description: 'AI for crops, advisory, climate risk and markets.', domainSkillId: 'domain-agriculture', moduleIds: ['agri-crops', 'agri-advisory', 'agri-markets', 'agri-challenge'] },
  { id: 'healthcare', name: 'Healthcare', shortName: 'Healthcare', professional: 'Healthcare Professionals', competency: 'Safe AI-Assisted Healthcare Delivery', icon: 'HeartPulse', color: '#e11d48', description: 'AI for documentation, decision support and health data.', domainSkillId: 'domain-healthcare', moduleIds: ['hc-admin', 'hc-decision', 'hc-data', 'hc-challenge'] },
  { id: 'education', name: 'Education', shortName: 'Education', professional: 'Educators', competency: 'AI-Enhanced Teaching & Learning', icon: 'GraduationCap', color: '#4f46e5', description: 'AI for lesson planning, assessment and personalised learning.', domainSkillId: 'domain-education', moduleIds: ['edu-planning', 'edu-assessment', 'edu-personalised', 'edu-challenge'] },
  { id: 'data-analytics', name: 'Data & Analytics', shortName: 'Data Analytics', professional: 'Data Professionals', competency: 'AI-Augmented Data Analysis', icon: 'BarChart3', color: '#0d9488', description: 'AI across querying, visualisation, storytelling and prediction.', domainSkillId: 'domain-data-analytics', moduleIds: ['da-foundations', 'da-visualisation', 'da-ml', 'da-challenge'] },
];
